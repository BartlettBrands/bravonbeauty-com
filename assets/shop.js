    ...
    if (PAGE.hasClass('template-index')) {
      ...
      smallPromos = function() {
        ...
        if (clientWidth >= mq_small) {
           $('.small-promos .image-text-widget .caption').css("display","");
          // only hide/show for hover on larger screens. used to control layout better for mobile
          return $('.small-promos .image-text-widget').mouseenter(function() {
           ...
           $('.small-promos .image-text-widget').unbind();
...
//     if (PAGE.hasClass('page-tools')) {
//       // this moves the sharpener to the bottom of the page for a better shopping experience
//       var $sharpener = $('.product-item[data-product-url*="precision-gel-pencil-sharpener"]');
//       $sharpener.appendTo(".product-grid");
//     }
  ...
  $('.template-index .small-promos .caption').css('display', 'block');
